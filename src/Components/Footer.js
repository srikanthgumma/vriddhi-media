        ...
        <div className=" py-4 text-gray-400">
          <div className="container px-4 mx-auto">
            <div className="-mx-4 flex flex-wrap justify-between">
              ...
              <div className="px-4 my-4 w-full sm:w-auto">
                <div>
                  <h2 className="inline-block text-2xl pb-4 mb-4 border-b-4 border-blue-900 font-sans font-bold hover:text-white">Blog</h2>
                </div>
                <ul className="leading-8">
                  <li><a href="#" className="hover:text-white font-sans ">Getting Started With Vriddhi Media</a></li>
                  <li><a href="#" className="hover:text-white font-sans ">Vriddhi Media Blogs</a></li>
                  <li><a href="#" className="hover:text-white font-sans">Vriddhi Medi blogs </a></li>
                  <li><a href="#" className="hover:text-white font-sans">5 Tips to grow faster</a></li>
                  <li><a href="#" className="hover:text-white font-sans">See More</a></li>
                </ul>
              </div>
              <div className="px-4 my-4 w-full sm:w-auto ">
                <div>
